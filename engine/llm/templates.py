...
Output a JSON with the following fields:
    - "text": the next short paragraph of the story. No more than 280 characters. Narrated on the style of Truman Capote's In Cold Blood. Add title. Use Markdown syntax. E.g title in bold as *title*. E.g italic for thoughts or quotes. VERY IMPORTANT
...
Output a JSON with the following fields:
    - "text": the next short paragraph of the story. No more than 280 characters. Narrated on the style of Truman Capote's In Cold Blood. Use Markdown syntax. E.g italic for thoughts or quotes. VERY IMPORTANT
    - "image": a DALL·E prompt; text description to generate the image on a text-to-image model
